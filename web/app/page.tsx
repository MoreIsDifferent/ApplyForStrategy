        ...
        <div className="flex flex-col gap-4 text-[15px] text-charcoal leading-relaxed">
          ...
          <p className="flex items-start gap-2">
            <span>
              ...
              Kenan-Flagler, and Isin is a Professor of Strategy at UNC Kenan-Flagler. If you have suggestions,
            ...
            <a
              ...
              title="Email Yi Hao"
              className="flex-shrink-0 text-accent hover:text-accent-soft-text mt-0.5"
            >
